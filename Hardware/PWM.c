...
void PWM_SetCompare1(uint16_t Compare)		//TIM2通道1->A0
{
	TIM_SetCompare1(TIM2, Compare);
}

void PWM_SetCompare2(uint16_t Compare)		//TIM2通道2->A1
{
	TIM_SetCompare2(TIM2, Compare);
}

void PWM_SetCompare3(uint16_t Compare)		//TIM2通道3->A2
{
	TIM_SetCompare3(TIM2, Compare);
}

void PWM_SetCompare4(uint16_t Compare)		//TIM2通道2->A3
{
